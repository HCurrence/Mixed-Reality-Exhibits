...
| 5. Add the Capability for Certian Objects to be Snapped to the Ground in Edit Mode | Certian objects, like statues, will need to be and should be attached to the ground. Other objects may also benefit from an optional, On-And-Off button for this. | 11/15/2022 | TBD | 
